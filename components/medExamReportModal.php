            ...
            <?php
                ...
                */
                ...
                medExamRadioAndInput('col-span-1',
                                    ...
                                    'pattern="[0-9]+" maxLength="3" title="Please enter only numbers"');
                ...
                medExamRadioAndInput('col-span-1',
                                    'Drug Use',
                                    'medExamReport_personalSocial_drugUse',
                                    null,
                                    null,
                                    $medExamReport['medExamReport_personalSocial_drugUse'] ?? "");

                medExamRadioAndInput('col-span-1',
                                    'Allergy',
                                    'medExamReport_personalSocial_allergy',
                                    null,
                                    null,
                                    $medExamReport['medExamReport_personalSocial_allergy'] ?? "");
                ...
                medExamInput('col-span-1 lg:col-span-2 flex items-baseline gap-x-2 -mt-4 border-l pl-4 sm:border-0 sm:pl-6',
                            'date',
                            "<span class='text-xs text-gray-500'>Last Menstrual Period:</span>",
                            'medExamReport_personalSocial_forWomen_period',
                            $medExamReport['medExamReport_personalSocial_forWomen_period'] ?? "",
                            'maxLength="10"');

                medExamInput('col-span-1 lg:col-span-2 flex items-baseline gap-x-2 -mt-2 border-l pl-4 sm:border-0 sm:pl-6',
                            'text',
                            "<span class='text-xs text-gray-500'>Lasting:</span>",
                            'medExamReport_personalSocial_lasting',
                            $medExamReport['medExamReport_personalSocial_lasting'] ?? "",
                            'placeholder=Days pattern="[0-9]+" maxLength="3" title="Please enter only numbers"');

                medExamRadioAndInput('col-span-1',
                            'Are you pregnant or any chance you may be',
                            'medExamReport_personalSocial_pregnant',
                            '',
                            'medExamReport_personalSocial_pregnant_note',
                            $medExamReport['medExamReport_personalSocial_pregnant'] ?? "",
                            $medExamReport['medExamReport_personalSocial_pregnant_note'] ?? "",
                            'maxLength="60"');
                ...
                medExamRadioAndInput('col-span-1',
                                    'Hypertension',
                                    'medExamReport_family_hypertension',
                                    'Remarks',
                                    'medExamReport_family_hypertension_note',
                                    $medExamReport['medExamReport_family_hypertension'] ?? "",
                                    $medExamReport['medExamReport_family_hypertension_note'] ?? "",
                                    'maxLength="60"'
                                );

                medExamRadioAndInput('col-span-1',
                                    'Heart Disease',
                                    'medExamReport_family_heartDisease',
                                    'Remarks',
                                    'medExamReport_family_heartDisease_note',
                                    $medExamReport['medExamReport_family_heartDisease'] ?? "",
                                    $medExamReport['medExamReport_family_heartDisease_note'] ?? "",
                                    'maxLength="60"'
                                );

                medExamRadioAndInput('col-span-1',
                                    'Kidney Disease',
                                    'medExamReport_family_kidneyDisease',
                                    'Remarks',
                                    'medExamReport_family_kidneyDisease_note',
                                    $medExamReport['medExamReport_family_kidneyDisease'] ?? "",
                                    $medExamReport['medExamReport_family_kidneyDisease_note'] ?? "",
                                    'maxLength="60"'
                                );

                medExamRadioAndInput('col-span-1',
                                    'Diabetes Mellitus',
                                    'medExamReport_family_diabetesMellitus',
                                    'Remarks',
                                    'medExamReport_family_diabetesMellitus_note',
                                    $medExamReport['medExamReport_family_diabetesMellitus'] ?? "",
                                    $medExamReport['medExamReport_family_diabetesMellitus_note'] ?? "",
                                    'maxLength="60"'
                                );

                medExamRadioAndInput('col-span-1',
                                    'Others',
                                    'medExamReport_family_others',
                                    'Remarks',
                                    'medExamReport_family_others_note',
                                    $medExamReport['medExamReport_family_others'] ?? "",
                                    $medExamReport['medExamReport_family_others_note'] ?? "",
                                    'maxLength="60"'
                                );
                sectionClose();
                ...
                medExamRadioAndInput('col-span-1 lg:col-span-2',
                                    'With Objective findings?',
                                    'medExamReport_system_findings',
                                    null,
                                    null,
                                    $medExamReport['medExamReport_system_findings'] ?? ""
                                );

                medExamRadioAndInput('col-span-1',
                                    'Eyes',
                                    'medExamReport_system_eyes',
                                    'Remarks',
                                    'medExamReport_system_eyes_note',
                                    $medExamReport['medExamReport_system_eyes'] ?? "",
                                    $medExamReport['medExamReport_system_eyes_note'] ?? "",
                                    'maxLength="60"'
                                );

                medExamRadioAndInput('col-span-1',
                                    'ENT/Mouth',
                                    'medExamReport_system_entMouth',
                                    'Remarks',
                                    'medExamReport_system_entMouth_note',
                                    $medExamReport['medExamReport_system_entMouth'] ?? "",
                                    $medExamReport['medExamReport_system_entMouth_note'] ?? "",
                                    'maxLength="60"'
                                );

                medExamRadioAndInput('col-span-1',
                                    'Cardiovascular',
                                    'medExamReport_system_cardiovascular',
                                    'Remarks',
                                    'medExamReport_system_cardiovascular_note',
                                    $medExamReport['medExamReport_system_cardiovascular'] ?? "",
                                    $medExamReport['medExamReport_system_cardiovascular_note'] ?? "",
                                    'maxLength="60"'
                                );

                medExamRadioAndInput('col-span-1',
                                    'Respiratory',
                                    'medExamReport_system_respiratory',
                                    'Remarks',
                                    'medExamReport_system_respiratory_note',
                                    $medExamReport['medExamReport_system_respiratory'] ?? "",
                                    $medExamReport['medExamReport_system_respiratory_note'] ?? "",
                                    'maxLength="60"'
                                );

                medExamRadioAndInput('col-span-1',
                                    'Gastrointestinal',
                                    'medExamReport_system_gastrointestinal',
                                    'Remarks',
                                    'medExamReport_system_gastrointestinal_note',
                                    $medExamReport['medExamReport_system_gastrointestinal'] ?? "",
                                    $medExamReport['medExamReport_system_gastrointestinal_note'] ?? "",
                                    'maxLength="60"'
                                );

                medExamRadioAndInput('col-span-1',
                                    'Genitourinary',
                                    'medExamReport_system_genitourinary',
                                    'Remarks',
                                    'medExamReport_system_genitourinary_note',
                                    $medExamReport['medExamReport_system_genitourinary'] ?? "",
                                    $medExamReport['medExamReport_system_genitourinary_note'] ?? "",
                                    'maxLength="60"'
                                );

                medExamRadioAndInput('col-span-1',
                                    'Musculoskeletal',
                                    'medExamReport_system_musculoskeletal',
                                    'Remarks',
                                    'medExamReport_system_musculoskeletal_note',
                                    $medExamReport['medExamReport_system_musculoskeletal'] ?? "",
                                    $medExamReport['medExamReport_system_musculoskeletal_note'] ?? "",
                                    'maxLength="60"'
                                );

                medExamRadioAndInput('col-span-1',
                                    'Skin/Breast',
                                    'medExamReport_system_skinOrBreast',
                                    'Remarks',
                                    'medExamReport_system_skinOrBreast_note',
                                    $medExamReport['medExamReport_system_skinOrBreast'] ?? "",
                                    $medExamReport['medExamReport_system_skinOrBreast_note'] ?? "",
                                    'maxLength="60"'
                                );

                medExamRadioAndInput('col-span-1',
                                    'Neurological',
                                    'medExamReport_system_neurological',
                                    'Remarks',
                                    'medExamReport_system_neurological_note',
                                    $medExamReport['medExamReport_system_neurological'] ?? "",
                                    $medExamReport['medExamReport_system_neurological_note'] ?? "",
                                    'maxLength="60"'
                                );

                medExamRadioAndInput('col-span-1',
                                    'Endocrine',
                                    'medExamReport_system_endocrine',
                                    'Remarks',
                                    'medExamReport_system_endocrine_note',
                                    $medExamReport['medExamReport_system_endocrine'] ?? "",
                                    $medExamReport['medExamReport_system_endocrine_note'] ?? "",
                                    'maxLength="60"'
                                );

                medExamRadioAndInput('col-span-1',
                                    'Hematological',
                                    'medExamReport_system_hematological',
                                    'Remarks',
                                    'medExamReport_system_hematological_note',
                                    $medExamReport['medExamReport_system_hematological'] ?? "",
                                    $medExamReport['medExamReport_system_hematological_note'] ?? "",
                                    'maxLength="60"'
                                );

                medExamRadioAndInput('col-span-1',
                                    'Others',
                                    'medExamReport_system_others',
                                    'Remarks',
                                    'medExamReport_system_others_note',
                                    $medExamReport['medExamReport_system_others'] ?? "",
                                    $medExamReport['medExamReport_system_others_note'] ?? "",
                                    'maxLength="60"'
                                );
                ...
                medExamInput('col-span-1',
                    'text',
                    'Height (cm)',
                    'medExamReport_physical_height',
                    $medExamReport['medExamReport_physical_height'] ?? "",
                    'maxLength="10" pattern="^\d+(\.\d+)?$" title="Please enter only numbers"'
                );

                medExamInput('col-span-1',
                    'text',
                    'Weight (kg)',
                    'medExamReport_physical_weight',
                    $medExamReport['medExamReport_physical_weight'] ?? "",
                    'maxLength="10" pattern="^\d+(\.\d+)?$" title="Please enter only numbers"'
                );
                ...
                medExamInput('col-span-1',
                    'text',
                    'Body Mass Index',
                    'medExamReport_physical_bmi',
                    $medExamReport['medExamReport_physical_bmi'] ?? "",
                    'maxLength="10" pattern="^\d+(\.\d+)?$" title="Please enter only numbers"'
                );
                ...
                medExamInput('col-span-1',
                    'text',
                    'Blood Pressure',
                    'medExamReport_physical_bp',
                    $medExamReport['medExamReport_physical_bp'] ?? "",
                ...
                medExamInput('col-span-1',
                    'text',
                    'Pulse Rate',
                    'medExamReport_physical_pr',
                    $medExamReport['medExamReport_physical_pr'] ?? "",
                    'maxLength="10" pattern="^\d+(\.\d+)?$" title="Please enter only numbers"'
                );
                ...
                medExamInput('col-span-1',
                    'text',
                    'Respiratory rate   ',
                    'medExamReport_physical_rr',
                    $medExamReport['medExamReport_physical_rr'] ?? "",
                    'maxLength="10" pattern="^\d+(\.\d+)?$" title="Please enter only numbers"'
                );

                medExamInput('col-span-1 md:col-span-2',
                    'text', 
                    "<span class='block whitespace-nowrap text-ellipsis overflow-hidden'>Visual Acuity R/L Right</span>", 
                    'medExamReport_physical_visual',
                    $medExamReport['medExamReport_physical_visual'] ?? "",
                    'maxLength="60"'
                );
                ...
                medExamInput('col-span-1',
                    'text',
                    'Hearing',
                    'medExamReport_physical_hearing',
                    $medExamReport['medExamReport_physical_hearing'] ?? "",
                    'maxLength="60"'
                );
                ...
                medExamInput('col-span-1',
                    'text',
                    'Clarity of Speech',
                    'medExamReport_physical_speech',
                    $medExamReport['medExamReport_physical_speech'] ?? "",
                    'maxLength="60"'
                );
                ...
                medExamRadioAndInput('physical-examination-item col-span-1',
                    'General Appearance',
                    'medExamReport_physical_generalAppearance',
                    'Remarks',
                    'medExamReport_physical_generalAppearance_note',
                    $medExamReport['medExamReport_physical_generalAppearance'] ?? "",
                    $medExamReport['medExamReport_physical_generalAppearance_note'] ?? "",
                    'maxLength="60"'
                );
                
                medExamRadioAndInput('physical-examination-item col-span-1',
                    'Skin',
                    'medExamReport_physical_skin',
                    'Remarks',
                    'medExamReport_physical_skin_note',
                    $medExamReport['medExamReport_physical_skin'] ?? "",
                    $medExamReport['medExamReport_physical_skin_note'] ?? "",
                    'maxLength="60"'
                );
                
                medExamRadioAndInput('physical-examination-item col-span-1',
                    'Head & Neck',
                    'medExamReport_physical_headNeck',
                    'Remarks',
                    'medExamReport_physical_headNeck_note',
                    $medExamReport['medExamReport_physical_headNeck'] ?? "",
                    $medExamReport['medExamReport_physical_headNeck_note'] ?? "",
                    'maxLength="60"'
                );
                
                medExamRadioAndInput('physical-examination-item col-span-1',
                    'Ears, Eyes, Nose',
                    'medExamReport_physical_earsEyesNose',
                    'Remarks',
                    'medExamReport_physical_earsEyesNose_note',
                    $medExamReport['medExamReport_physical_earsEyesNose'] ?? "",
                    $medExamReport['medExamReport_physical_earsEyesNose_note'] ?? "",
                    'maxLength="60"'
                );
                
                medExamRadioAndInput('physical-examination-item col-span-1',
                    'Mouth/Throat',
                    'medExamReport_physical_mouthThroat',
                    'Remarks',
                    'medExamReport_physical_mouthThroat_note',
                    $medExamReport['medExamReport_physical_mouthThroat'] ?? "",
                    $medExamReport['medExamReport_physical_mouthThroat_note'] ?? "",
                    'maxLength="60"'
                );
                
                medExamRadioAndInput('physical-examination-item col-span-1',
                    'Chest Lungs',
                    'medExamReport_physical_chestLungs',
                    'Remarks',
                    'medExamReport_physical_chestLungs_note',
                    $medExamReport['medExamReport_physical_chestLungs'] ?? "",
                    $medExamReport['medExamReport_physical_chestLungs_note'] ?? "",
                    'maxLength="60"'
                );
                
                medExamRadioAndInput('physical-examination-item col-span-1',
                    'Back',
                    'medExamReport_physical_back',
                    'Remarks',
                    'medExamReport_physical_back_note',
                    $medExamReport['medExamReport_physical_back'] ?? "",
                    $medExamReport['medExamReport_physical_back_note'] ?? "",
                    'maxLength="60"'
                );
                
                medExamRadioAndInput('physical-examination-item col-span-1',
                    'Heart',
                    'medExamReport_physical_heart',
                    'Remarks',
                    'medExamReport_physical_heart_note',
                    $medExamReport['medExamReport_physical_heart'] ?? "",
                    $medExamReport['medExamReport_physical_heart_note'] ?? "",
                    'maxLength="60"'
                );
                
                medExamRadioAndInput('physical-examination-item col-span-1',
                    'Abdomen',
                    'medExamReport_physical_abdomen',
                    'Remarks',
                    'medExamReport_physical_abdomen_note',
                    $medExamReport['medExamReport_physical_abdomen'] ?? "",
                    $medExamReport['medExamReport_physical_abdomen_note'] ?? "",
                    'maxLength="60"'
                );
                
                medExamRadioAndInput('physical-examination-item col-span-1',
                    'Extremities',
                    'medExamReport_physical_extremities',
                    'Remarks',
                    'medExamReport_physical_extremities_note',
                    $medExamReport['medExamReport_physical_extremities'] ?? "",
                    $medExamReport['medExamReport_physical_extremities_note'] ?? "",
                    'maxLength="60"'
                );
                
                medExamRadioAndInput('physical-examination-item col-span-1',
                    'Neurological',
                    'medExamReport_physical_neurological',
                    'Remarks',
                    'medExamReport_physical_neurological_note',
                    $medExamReport['medExamReport_physical_neurological'] ?? "",
                    $medExamReport['medExamReport_physical_neurological_note'] ?? "",
                    'maxLength="60"'
                );
                
                medExamRadioAndInput('physical-examination-item col-span-1',
                    'Rectal',
                    'medExamReport_physical_rectal',
                    'Remarks',
                    'medExamReport_physical_rectal_note',
                    $medExamReport['medExamReport_physical_rectal'] ?? "",
                    $medExamReport['medExamReport_physical_rectal_note'] ?? "",
                    'maxLength="60"'
                );
                
                medExamRadioAndInput('physical-examination-item col-span-1',
                    'Breast',
                    'medExamReport_physical_breast',
                    'Remarks',
                    'medExamReport_physical_breast_note',
                    $medExamReport['medExamReport_physical_breast'] ?? "",
                    $medExamReport['medExamReport_physical_breast_note'] ?? "",
                    'maxLength="60"'
                );
                
                medExamRadioAndInput('physical-examination-item col-span-1',
                    'Genitalia',
                    'medExamReport_physical_genitalia',
                    'Remarks',
                    'medExamReport_physical_genitalia_note',
                    $medExamReport['medExamReport_physical_genitalia'] ?? "",
                    $medExamReport['medExamReport_physical_genitalia_note'] ?? "",
                    'maxLength="60"'
                );
                ...
                medExamRadioMulti(
                    ...
                    'medExamReport_xrayEcgLab_chestXray', 
                    'A. Chest X-Ray', 
                    array('PA', 'LORDOTIC'), 
                    null,
                    null, 
                    $medExamReport['medExamReport_xrayEcgLab_chestXray'] ?? '',
            
                );
                
                medExamRadioMulti(
                    'col-span-1 sm:col-span-3 -mt-5', 
                    'medExamReport_xrayEcgLab_chestXray_sub', 
                    '', 
                    array('Essentially Normal Chest', 'Significant Finding For Lordotic View', 'Minimal PTB, Activity Undetermined', 'Pneumonitis', 'Healed & Stable Ptb', 'Pulmonary Scar', 'Other'), 
                    '',
                    'medExamReport_xrayEcgLab_chestXray_other', 
                    $medExamReport['medExamReport_xrayEcgLab_chestXray_sub'] ?? '',
                    $medExamReport['medExamReport_xrayEcgLab_chestXray_other'] ?? ''
                );
                ...
                medExamRadioMulti(
                    ...
                    'B. ECG Report', 
                    array('Normal', 'Significant Findings', 'Not Required'),
                    null,
                    null,
                ...
                medExamInput(
                    'flex gap-x-2 items-baseline -mt-4 border-l flex gap-x-2 items-baseline pl-4 sm:pl-0 sm:border-0', 
                    'text', 
                    "<span class='text-xs text-gray-500'>Findings: WBC</span>", 
                    'medExamReport_xrayEcgLab_urinalysis_wbc',
                    $medExamReport['medExamReport_xrayEcgLab_urinalysis_wbc'] ?? '',
                    'placeholder="/hpf" maxLength="60"');

                medExamRadioMulti(
                    'sm:-mt-2 sm:pl-4', 
                    'medExamReport_xrayEcgLab_urinalysis', 
                    '', 
                    array('Normal', 'No Specimen'),
                    null,
                    null,
                    $medExamReport['medExamReport_xrayEcgLab_urinalysis'] ?? ''
                );
                ...
                medExamInput(
                    ...
                    'medExamReport_xrayEcgLab_stoolSample_positive', 
                    $medExamReport['medExamReport_xrayEcgLab_stoolSample_positive'] ?? '',
                    'placeholder="/hpf" maxLength="60"' 
                );
                
                medExamRadioMulti(
                    'sm:-mt-2 sm:pl-4', 
                    'medExamReport_xrayEcgLab_stoolSample', 
                    '', 
                    array('Normal', 'No Specimen'),
                    null,
                    null,
                    $medExamReport['medExamReport_xrayEcgLab_stoolSample'] ?? ''
                );
                ...
                medExamRadioMulti(
                    'col-span-1 sm:col-span-3', 
                    'medExamReport_xrayEcgLab_serologicalTest', 
                    'F. Serological Test (VDRL)', 
                    array('Reactive','Non-Reactive'),
                    null,
                    null,
                    $medExamReport['medExamReport_xrayEcgLab_serologicalTest'] ?? ''
                );

                medExamRadioMulti(
                    'col-span-1 sm:col-span-3', 
                    'medExamReport_xrayEcgLab_hepatitisAScreening', 
                    'G. Hepatitis - A Screening', 
                    array('Anti-HAV IgM Negative','Anti-HAV IgM Positive','Anti HAV IgG Positive'),
                    null,
                    null,
                    $medExamReport['medExamReport_xrayEcgLab_hepatitisAScreening'] ?? ''
                );

                medExamRadioMulti(
                    'col-span-1 sm:col-span-3', 
                    'medExamReport_xrayEcgLab_hepatitisBSurfaceAntigen', 
                    'H. Hepatitis - B Surface Antigen', 
                    array('Reactive','Non-Reactive','Not Required'),
                    null,
                    null,
                    $medExamReport['medExamReport_xrayEcgLab_hepatitisBSurfaceAntigen'] ?? ''
                );

                medExamRadioMulti(
                    'col-span-1 sm:col-span-3', 
                    'medExamReport_xrayEcgLab_pregnancyTest', 
                    'I. Pregnancy Test', 
                    array('Positive','Negative','Not Required'),
                    null,
                    null,
                    $medExamReport['medExamReport_xrayEcgLab_pregnancyTest'] ?? ''
                );

                medExamRadioMulti(
                    'col-span-1 sm:col-span-3', 
                    'medExamReport_xrayEcgLab_bloodType', 
                    'J. Blood Type', 
                    array('AB','A','B','O'),
                    null,
                    null,
                    $medExamReport['medExamReport_xrayEcgLab_bloodType'] ?? ''
                );

                medExamRadioMulti(
                    'col-span-1 sm:col-span-3', 
                    'medExamReport_xrayEcgLab_drugTest', 
                    'K. Drug Test', 
                    array(),
                    null,
                    null,
                    $medExamReport['medExamReport_xrayEcgLab_drugTest'] ?? ''
                );

                medExamRadioMulti(
                    'col-span-1 sm:col-span-3 flex gap-x-6 ml-6 -mt-4', 
                    'medExamReport_xrayEcgLab_marijuana', 
                    '<span class="text-xs text-gray-500">Marijuana (tetrahydrocannabinol):</span>', 
                    array('Negative','Positive'),
                    null,
                    null,
                    $medExamReport['medExamReport_xrayEcgLab_marijuana'] ?? ''
                );

                medExamRadioMulti(
                    'col-span-1 sm:col-span-3 flex gap-x-6 ml-6 -mt-8', 
                    'medExamReport_xrayEcgLab_shabu', 
                    '<span class="text-xs text-gray-500">Shabu (Methamphetamine):</span>', 
                    array('Negative','Positive'),
                    null,
                    null,
                    $medExamReport['medExamReport_xrayEcgLab_shabu'] ?? ''
                );
                ...
                medExamInput(
                    ...
                    'text', 
                    'Ratings', 
                    'medExamReport_recommendation_ratings_note',
                    $medExamReport['medExamReport_recommendation_ratings_note'] ?? '',
                    'maxLength="60"'
                );

                medExamRadioMulti(
                    '', 
                    'medExamReport_recommendation_ratings', 
                    '', 
                    array('Fit','Unfit','Pending'),
                    null,
                    null,
                    $medExamReport['medExamReport_recommendation_ratings'] ?? ''
                );
                ...
                sectionOpen('grid grid-cols-1 sm:grid-cols-4 gap-4 md:gap-5 p-4 md:p-5', 'medExamReport-section-physician');
                    ...
                    medExamInput(
                        ...
                        'date', 
                        'Date', 
                        'medExamReport_recommendation_date', 
                        date('Y-m-d')
                    );
