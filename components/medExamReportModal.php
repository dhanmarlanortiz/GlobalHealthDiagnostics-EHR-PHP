...
if (isset($_POST['generateMedExamReport'])) {
    ...
    // if ($conn->query($medExamReport_history_sql) === TRUE) {
    ...
    <dialog id="medExamReportModal" class="modal">
        <div class="modal-box rounded-none max-w-3xl lg:max-w-5xl p-0">
            ...
            <?php 
                ...
                medExamInput('col-span-1', 'text', 'Childhood Illness', 'medExamReport_history_childhoodIllness');
                medExamInput('col-span-1', 'text', 'Past Illness', 'medExamReport_history_pastIllness');
                medExamInput('col-span-1', 'text', 'Present Illness', 'medExamReport_history_presentIllness');
                medExamInput('col-span-1', 'text', 'Supplements', 'medExamReport_history_supplements');
                medExamInput('col-span-1', 'text', 'Surgeries', 'medExamReport_history_surgeries');
                medExamInput('col-span-1', 'text', 'Hospitalizations', 'medExamReport_history_hospitalizations');
                sectionClose();
            ?>
            ...
            <?php 
                ...
                medExamRadioAndInput('col-span-1', 'Smoking History', 'medExamReport_personalSocial_smokingHistory', 'Pack per', 'medExamReport_personalSocial_smokingHistory_pack');
                medExamRadioAndInput('col-span-1', 'Alcohol Intake', 'medExamReport_personalSocial_alcoholIntake', 'Bottle per', 'medExamReport_personalSocial_alcoholIntake_bottle');
                ...
                medExamInput('col-span-1 lg:col-span-2 flex items-baseline gap-x-2 -mt-2 border-l pl-4 sm:border-0 sm:pl-0 ', 'number', "<span class='text-xs text-gray-500'>Lasting:</span>", 'medExamReport_personalSocial_lasting', null, 'placeholder=Days');
            ...
            <?php 
                ...
                For Lordotic View', 'Minimal PTB, Activity Undetermined', 'Pneumonitis', 'Healed & Stable Ptb', 'Pulmonary Scar'), 'Others:', 'medExamReport_xrayEcgLab_chestXray_other');
