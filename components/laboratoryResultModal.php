...
if (isset($_POST['generateLaboratoryResult'])) {
    ...
    header("Location: " . $url ."");
    exit();
} else if (isset($_POST['updateLaboratoryResult'])) {

    $labResGenQuery =  "UPDATE LaboratoryResult
                    SET labRes_user_FK = '" . clean( $_POST['labRes_user_FK'] ) . "',
                        labRes_date = '" . clean( $_POST['labRes_date'] ) . "',
                        labRes_hepa_b = '" . clean( $_POST['labRes_hepa_b'] ) . "',
                        labRes_drug_shabu = '" . clean( $_POST['labRes_drug_shabu'] ) . "',
                        labRes_drug_marijuana = '" . clean( $_POST['labRes_drug_marijuana'] ) . "',
                        labRes_hema_hemoglobin = '" . clean( $_POST['labRes_hema_hemoglobin'] ) . "',
                        labRes_hema_hematocrit = '" . clean( $_POST['labRes_hema_hematocrit'] ) . "',
                        labRes_hema_whiteblood = '" . clean( $_POST['labRes_hema_whiteblood'] ) . "',
                        labRes_hema_segmenters = '" . clean( $_POST['labRes_hema_segmenters'] ) . "',
                        labRes_hema_lymphocytes = '" . clean( $_POST['labRes_hema_lymphocytes'] ) . "',
                        labRes_hema_monocytes = '" . clean( $_POST['labRes_hema_monocytes'] ) . "',
                        ...
                        labRes_urin_gravity = '" . clean( $_POST['labRes_urin_gravity'] ) . "',
                        labRes_urin_protein = '" . clean( $_POST['labRes_urin_protein'] ) . "',
                        labRes_urin_glucose = '" . clean( $_POST['labRes_urin_glucose'] ) . "',
                        labRes_urin_wbc = '" . clean( $_POST['labRes_urin_wbc'] ) . "',
                        labRes_urin_rbc = '" . clean( $_POST['labRes_urin_rbc'] ) . "',
                        labRes_urin_mucous = '" . clean( $_POST['labRes_urin_mucous'] ) . "',
                        labRes_urin_epithelial = '" . clean( $_POST['labRes_urin_epithelial'] ) . "',
                        labRes_urin_amorphous = '" . clean( $_POST['labRes_urin_amorphous'] ) . "',
                        labRes_urin_bacteria = '" . clean( $_POST['labRes_urin_bacteria'] ) . "',
                        labRes_urin_cast = '" . clean( $_POST['labRes_urin_cast'] ) . "',
                        labRes_urin_crystals = '" . clean( $_POST['labRes_urin_crystals'] ) . "',
                        labRes_para_color = '" . clean( $_POST['labRes_para_color'] ) . "',
                        labRes_para_consistency = '" . clean( $_POST['labRes_para_consistency'] ) . "',
                        labRes_para_result = '" . clean( $_POST['labRes_para_result'] ) . "'
                    WHERE labRes_APE_FK = $id";
    ...
    <dialog id="laboratoryResultModal" class="modal">
        <div class="modal-box rounded-none max-w-7xl p-0 bg-white">
                ...
                <div class="flex items-center justify-end flex-col sm:flex-row gap-x-1 p-4 border-t-2 border-green-700 mt-6">
                    ...
                    <?php if(!empty($laboratoryResult)) { ?>
                        <input type="submit" name="updateLaboratoryResult" value="Save Changes" class="<?php echo $classBtnPrimary; ?> w-full sm:w-auto mb-2 sm:mb-0">
                    <?php } else { ?>
