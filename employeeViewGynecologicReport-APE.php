...
if($_SESSION['role'] == 1) {
    include('navbar.php');
    createMainHeader($organizationDetail['name'], array("Home", "Organizations", $organizationDetail['name'], "Annual Physical Examination", "Gynecologic Report"));
} else if($_SESSION['role'] == 2) { 
    include('client/navbar.php');
    createMainHeader($organizationDetail['name'], array("Annual Physical Examination", "Gynecologic Report"));
...
<main class='mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8'>
    <?php createFormHeader( $firstName . " " . $middleName . " " . $lastName . " - Gynecologic Report" ); ?>
