    ...
    private function processCSVLine($line, $o)
{
    ...
    $prevStmt->bind_param("sss", $firstName, $middleName, $lastName);
    $prevStmt->execute();
    ...
    if ($prevResult->num_rows > 0) {
        ...
        $updateStmt->bind_param("sssssssssssi", $firstName, $middleName, $lastName, $age, $sex, $employeeNumber, $department, $membership, $level, $dateRegistered, $examination, $PrevId);
        ...
        $insertStmt->bind_param("ssssssssssssi", $firstName, $middleName, $lastName, $age, $sex, $employeeNumber, $department, $membership, $level, $dateRegistered, $examination, $o, $_SESSION['userId']);
