...
<nav class="bg-green-700">
            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div class="hidden sm:ml-6 sm:block">
                    <div class="flex space-x-4">
                        ...
                        <a href="<?php base_url(); ?>/organizations.php" class="<?php setActiveNav(array('organization', 'organizations', 'organizationDetails', 'createOrganization', 'employees-APE', 'employeeCreate-APE', 'employee-APE', 'employeesImport-APE', 'employeeViewResult-APE'), 'desktop') ?>">Organizations</a>
                    </div>
                </div>
            </div>
    ...
    <div class="hidden sm:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2">
            ...
            <a href="<?php base_url(); ?>/organizations.php" class="<?php setActiveNav(array('organization', 'organizations', 'organizationDetails', 'createOrganization', 'employees-APE', 'employeeCreate-APE', 'employee-APE', 'employeesImport-APE', 'employeeViewResult-APE'), 'mobile') ?>">Organizations</a>
        </div>
    </div>
</nav>
