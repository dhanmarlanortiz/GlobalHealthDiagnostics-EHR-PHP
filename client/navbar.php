<?php 
    ...
    //     $url = ($_SERVER['HTTP_HOST'] == 'app.globalhealth-diagnostics.com') ? "https://app.globalhealth-diagnostics.com/client" : "http://localhost/globalhealth-php/client";
    //     if($print === true) {
    //         echo $url;
    //     } else {
    //         return $url;
        ...
        <div class="relative flex h-16">
            <div class="flex flex-1 gap-5 items-center justify-between">
                <div class="flex flex-shrink-0 items-start">
                    <a href="<?php base_url(); ?>" class="flex content-center">
                        <img class="h-8 w-auto" src="../images/ghd-logo.png" />
                        <span class="text-gray-300 px-3 py-2 text-sm font-medium">Global Health Diagnostics</span>
                    </a>
                </div>
